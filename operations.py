from examples.example_calculator.calc_conf import register_node, OP_NODE_ADD, OP_NODE_SUB, OP_NODE_MUL, OP_NODE_DIV, OP_NODE_CUSTOM
...
class CalcNode_Custom(CalcNode):
    ...
    op_title = "CUSTOM"
    content_label = "CU"
    content_label_objname = "calc_node_cusom"
